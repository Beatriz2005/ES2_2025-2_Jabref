...
This export is not yet complete and some issues cannot be resolved without extension of the internal format modifier. E.g., the last author is separated by '&' which should be a ','.
